...
@Component({
  selector: 'informe-peritacion-danios-detalle',
  templateUrl: './informe-peritacion-danios-detalle.component.html',
  styleUrls: ['./informe-peritacion-danios-detalle.component.css']
})
export class InformePeritacionDaniosDetalleComponent implements OnInit {
