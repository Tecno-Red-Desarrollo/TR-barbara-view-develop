...
export class CamaraComponent implements OnDestroy, OnInit {
  // @Output() getPicture = new EventEmitter<WebcamImage>();
  @ViewChild('snapshot') snapshot?: ElementRef<HTMLElement>;
  ...
  triggerSnapshot(): void {
    ...
    const videoElement = (<HTMLElement>this.ElByClassName.nativeElement).querySelector(
      'video'
    );
