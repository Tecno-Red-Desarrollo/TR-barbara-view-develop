...
@Component({
  selector: 'informe-danios-detalle-verifeye',
  templateUrl: './informe-danios-detalle-verifeye.component.html',
  styleUrls: ['./informe-danios-detalle-verifeye.component.css']
})
export class InformeDaniosDetalleVerifeyeComponent implements OnInit {
